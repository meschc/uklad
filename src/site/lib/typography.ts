 ...
 * Этот файл — про неразрывный пробел, и сам символ встречается в нём дважды по
 * делу: в константе `NBSP` ниже и в комментарии, где показан как пример. В
 * любом другом файле невидимый пробел в коде остаётся опечаткой, и там правило
 * работает. Отключено на весь файл, а не строкой: строчный комментарий внутрь
 * блочного не поставишь.
 */
 ...
 */
function fixHangingPrepositions(root: Node): void {
